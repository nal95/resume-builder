...
import { UserBasicsComponent } from './user-basics.component';
import {User} from "../../resume-data/user.data";
import {of} from "rxjs";

describe('UserBasicsComponent', () => {
  let component: UserBasicsComponent;
  let fixture: ComponentFixture<UserBasicsComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UserBasicsComponent]
    })
    .compileComponents();

    fixture = TestBed.createComponent(UserBasicsComponent);
